    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> RemoteLogin()
        {
            ...
            var url = request.CreateAuthorizeUrl(
                        clientId: "netfx.client3",
                        responseType: OidcConstants.ResponseTypes.CodeIdToken,
                        responseMode: OidcConstants.ResponseModes.FormPost,
                        redirectUri: "http://10.37.11.12:6003/Home/CallBack",
        ...
        public async Task<ActionResult> CallBack()
        {
            ...
            keyPairs.Add(new KeyValuePair<string, string>("client_id", "netfx.client3"));
            ...
            keyPairs.Add(new KeyValuePair<string, string>("redirect_uri", "http://10.37.11.12:6003/Home/CallBack"));
        ...
        public async Task<ActionResult> Logout()
        {
            ...
            var logoutCallBack = @"http://10.37.11.12:6003/Home/LogoutCallBack";
